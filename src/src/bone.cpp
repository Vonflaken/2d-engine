...
{
	// Update position, rotation and scale values of parent bone
...
{
	return prevVal + ( nextVal - prevVal ) * ( double ) ( id - prevId ) / ( double ) ( nextId - prevId );
}

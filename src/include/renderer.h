...
public:
    ...
    virtual void DrawParallelogram( double x, double y, double offsetx, double offsety, double width, double height ) const;
	virtual void DrawImage(const Image* image, double x, double y, uint16 frame = 0, double width = 0.0f, double height = 0.0f, double ang = 0) const;
